import svgPaths from "./svg-3eb6c5k5pc";

export default function OlfMenu() {
  return (
    <div className="bg-[#faf9f9] content-stretch flex flex-col gap-[160px] items-start relative size-full" data-name="OLF menu">
      <div className="content-stretch flex flex-col items-start overflow-clip pt-[128px] relative shrink-0 w-full" data-name="Main">
        <div className="h-[1697px] max-w-[1536px] relative shrink-0 w-full" data-name="Hero Section">
          <div className="flex flex-col items-center max-w-[inherit] size-full">
            <div className="content-stretch flex flex-col gap-[15px] items-center max-w-[inherit] px-[32px] relative size-full">
              ...
              <div className="content-stretch flex flex-col h-[88px] items-center pt-[9px] relative shrink-0 w-full" data-name="Container">
                <div className="flex flex-col font-['Epilogue:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#363636] text-[24px] text-center tracking-[-0.6px] uppercase w-[812px]">
              ...
              <div className="content-stretch flex flex-col font-['Epilogue:Bold',sans-serif] font-bold h-[357px] items-center leading-[0] pt-[9px] relative shrink-0 text-[#363636] text-[24px] text-center tracking-[-0.6px] uppercase w-full" data-name="Container">
                <div className="flex flex-col justify-center relative shrink-0 w-[812px] whitespace-pre-wrap">
                ...
                <div className="flex flex-col justify-center relative shrink-0 w-[812px]">
                  <p>
              ...
              <div className="content-stretch flex flex-col font-['Epilogue:Bold',sans-serif] font-bold h-[152px] items-center leading-[0] pt-[9px] relative shrink-0 text-[#363636] text-center tracking-[-0.6px] uppercase w-full whitespace-pre-wrap" data-name="Container">
                <div className="flex flex-col justify-center relative shrink-0 text-[74px] w-[812px]">
                ...
                <div className="flex flex-col justify-center relative shrink-0 text-[24px] w-[812px]">
      ...
      <div className="absolute backdrop-blur-[12px] bg-[rgba(250,249,249,0.8)] content-stretch flex flex-col items-start left-0 top-0 w-[1280px]" data-name="TopNavBar">
